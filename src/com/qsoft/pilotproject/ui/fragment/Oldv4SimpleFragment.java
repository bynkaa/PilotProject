...
public class Oldv4SimpleFragment extends Fragment
{
    ...
    void afterViews()
    {
        if (!(getParentFragment() instanceof Oldv4SimpleFragment))
        {
    ...
    {
        getFragmentManager().beginTransaction().replace(R.id.container, new Oldv4SimpleFragment_()).addToBackStack(null).commit();
    }

    @Click(R.id.button_add_sub_fragment)
    void doClickAddSubFragment()
    {
        currentHostFragment = new Oldv4SimpleFragment_();
